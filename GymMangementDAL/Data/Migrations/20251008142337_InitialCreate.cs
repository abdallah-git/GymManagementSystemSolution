        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Hieght = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("Gymuservalidemailcheh", "Email Like '_%@_%._%' ");
                    table.CheckConstraint("Gymuservalidphonecheh", "Phone Like '01%' and Phone Not Like '%[^0-9]%' ");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("Plandurationvheck", "DurationDayes BetWeen 1 and 365");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("Gymuservalidemailcheh1", "Email Like '_%@_%._%' ");
                    table.CheckConstraint("Gymuservalidphonecheh1", "Phone Like '01%' and Phone Not Like '%[^0-9]%' ");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("sessioncapictyvalid ", "Capacity BetWeen 1 and 25 ");
